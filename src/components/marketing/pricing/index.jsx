...
const Pricing = ({ status }) => {
    ...
    return (
        <>
            <section className="py-16 md:py-24 bg-gradient-to-b from-background to-secondary/20 text-foreground">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
                    ...
                    <motion.div
                        ...
                        animate="visible"
                    >
                        <div className="flex items-center space-x-3 p-2 bg-card rounded-full shadow-md border border-border">
                    ...
                    ${plan.isRecommended ? "border-primary bg-primary/5" : "border-border bg-card"}
                    ${isDisabled ? "opacity-60 cursor-not-allowed" : ""}`}
                                    >
                                        ...
                                        <CardHeader className={`pt-10 pb-6 ${plan.isRecommended ? "pt-14" : ""}`}>
                                            <div className="flex items-center gap-3 mb-3">
                                                <div className={`p-2 rounded-full bg-card shadow-inner ${plan.isRecommended ? "bg-primary/10" : ""}`}>
                                                    {plan.icon}
                                                </div>
                                            ...
                                            <ul className="space-y-2.5">
                                                {plan.features.map((feature, key) => (
                                                    <li key={key} className="flex items-start">
                                                        ...
                                                        <span className="text-sm lg:text-base text-foreground/90">{feature}</span>
                                                    </li>
                                                ))}
                                            </ul>
                                        </CardContent>
                          ...
                          ${plan.isRecommended ? "bg-primary hover:bg-blue-700 text-primary-foreground focus:ring-primary"
                                                        : plan.buttonVariant === "outline" ? "text-white bg-primary hover:bg-blue-700 focus:ring-primary"
