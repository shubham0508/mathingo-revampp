    ...
    content: `
      <div class="space-y-8 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <section id="why-verification-matters" class="scroll-mt-24">
          <h2 class="text-3xl font-bold text-foreground dark:text-white mt-12 mb-6 border-l-4 border-primary pl-4">Why Instant Solution Verification is a Game-Changer</h2>
          <p class="mb-6">
          ...
          <ul class="list-disc list-outside pl-8 mb-8 space-y-3 text-foreground/90 dark:text-slate-300">
        ...
        <section id="how-it-works" class="scroll-mt-24">
          <h2 class="text-3xl font-bold text-foreground dark:text-white mt-12 mb-6 border-l-4 border-primary pl-4">How Mathz AI's AI-Powered Smart Solution Check Works: A Seamless Process</h2>
        ...
        <section id="upload-your-work" class="scroll-mt-24">
          <h3 class="text-2xl font-semibold text-foreground dark:text-white mt-10 mb-4">Step 1: Upload Your Work with Ease</h3>
          <p class="mb-6">
          ...
          <blockquote class="border-l-4 border-primary/50 dark:border-primary/70 pl-6 italic my-8 py-2 text-foreground/80 dark:text-slate-400">
        ...
        <section id="ai-analysis" class="scroll-mt-24">
          <h3 class="text-2xl font-semibold text-foreground dark:text-white mt-10 mb-4">Step 2: AI-Powered In-Depth Analysis</h3>
          <p class="mb-6">
          ...
          <div class="bg-card dark:bg-slate-800 p-6 rounded-xl shadow-lg border border-border dark:border-slate-700 mb-8">
        ...
        <section id="optimized-solutions" class="scroll-mt-24">
          <h3 class="text-2xl font-semibold text-foreground dark:text-white mt-10 mb-4">Step 3: Optimized Solution & Learning Delivery</h3>
          <p class="mb-6">
            Mathz AI goes beyond simple error flagging. We believe in learning through correction. You'll receive:
          </p>
          <div class="bg-card dark:bg-slate-800 p-6 rounded-xl shadow-lg border border-border dark:border-slate-700 mb-8 space-y-4">
            <div>
        ...
        <section id="mathzai-vs-generic" class="scroll-mt-24">
          <h2 class="text-3xl font-bold text-foreground dark:text-white mt-12 mb-6 border-l-4 border-primary pl-4">Why Mathz AI Excels Over Generic AI Tools</h2>
          <p class="mb-6">
          ...
          <div class="grid md:grid-cols-2 gap-6 mb-8">
            <div class="bg-card dark:bg-slate-800 border border-border dark:border-slate-700 p-6 rounded-xl shadow-lg">
        ...
        <section id="learning-impact" class="scroll-mt-24">
          <h2 class="text-3xl font-bold text-foreground dark:text-white mt-12 mb-6 border-l-4 border-primary pl-4">The Proven Impact on Student Learning & Confidence</h2>
          <p class="mb-6">
    ...
    content: `
      <div class="space-y-8 text-lg leading-relaxed text-gray-700 dark:text-gray-300">
        ...
        <section id="calculus-challenges" class="scroll-mt-24">
          <h2 class="text-3xl font-bold text-foreground dark:text-white mt-12 mb-6 border-l-4 border-primary pl-4">The Common Hurdles in Learning Calculus</h2>
